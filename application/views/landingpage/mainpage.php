            ...
            <div class="row h-100">
                <div class="col-12 my-auto">
                    <div class="masthead-content text-white py-5 py-md-0">
                        ...
                        <a href="#"><img src="<?php echo base_url('assets/png/trueconf.png') ?>" class="img-fluid rounded mt-4" alt="" style="width: 70%; height: 70%"></a>

                        <a href="#"><img src="<?php echo base_url('assets/png/kolibri.png') ?>" class="img-fluid rounded mt-4" alt="" style="width: 70%; height: 70%"></a>
